...
function createFilmMaker($filmMaker)
{
    ...
    try {
        $dbh = getPDO();
        $query = "INSERT INTO filmmakers (firstname,lastname, filmmakersnumber,birthname,nationality) VALUES (:firstname, :lastname, :filmmakersnumber, :birthname, :nationality)";
        $statement = $dbh->prepare($query);//prepare query
        $statement->execute($filmMaker);//execute query
